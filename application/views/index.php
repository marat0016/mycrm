            ...
            <section class="vbox">
              <section class="scrollable padder">
                <section class="row m-b-md">
                  <div class="col-sm-6">
                    <h3 class="m-b-xs text-black">Рабочий стол</h3>
                  </div>
                  <div class="col-sm-6 text-right text-left-xs m-t-md">
                    <a href="#" class="btn btn-s-md btn-success">Новая сделка</a>
                  ...
                  <div class="col-md-4">
                    <section class="panel b-a">
                      ...
                      <div class="panel-body"> <a href="#" class="block h4 font-bold m-b text-black">Get started with Bootstrap</a>
                        ...
                        <div class="m-b"> <a href="#" class="avatar thumb-sm"> <img src="assets/images/a0.jpg"> <i class="on b-white"></i> </a> <a href="#" class="avatar thumb-sm"> <img src="assets/images/a1.jpg"> <i class="busy b-white"></i> </a> <a href="#" class="avatar thumb-sm"> <img src="assets/images/a2.jpg"> <i class="away b-white"></i> </a> <a href="#" class="avatar thumb-sm"> <img src="assets/images/a3.jpg"> <i class="off b-white"></i> </a> <a href="#" class="btn btn-info btn-rounded font-bold"> +152 </a> </div>
                        <p class="text-sm">Start at 2:00 PM, 12/5/2016</p>
                        <a href="#" class="btn btn-default btn-sm btn-rounded m-b-xs"><i class="fa fa-plus"></i> Take me in</a> </div>
                      <div class="clearfix panel-footer"> <small class="text-muted pull-right">5m ago</small> <a href="#" class="thumb-sm pull-left m-r"> <img src="assets/images/a0.jpg" class="img-circle"> </a>
                  ...
                  <div class="col-md-4">
                    <section class="panel b-a">
                      ...
                      <ul class="list-group list-group-lg no-bg auto">
                        <a href="#" class="list-group-item clearfix"> <span class="pull-left thumb-sm avatar m-r"> <img src="assets/images/a4.jpg" alt="John said"> <i class="on b-white bottom"></i> </span> <span class="clear"> <span>Chris Fox</span> <small class="text-muted clear text-ellipsis">What's up, buddy</small> </span> </a> <a href="#" class="list-group-item clearfix"> <span class="pull-left thumb-sm avatar m-r"> <img src="assets/images/a5.jpg" alt="John said"> <i class="on b-white bottom"></i> </span> <span class="clear"> <span>Amanda Conlan</span> <small class="text-muted clear text-ellipsis">Come online and we need talk about the plans that we have discussed</small> </span> </a> <a href="#" class="list-group-item clearfix"> <span class="pull-left thumb-sm avatar m-r"> <img src="assets/images/a6.jpg" alt="John said"> <i class="busy b-white bottom"></i> </span> <span class="clear"> <span>Dan Doorack</span> <small class="text-muted clear text-ellipsis">Hey, Some good news</small> </span> </a> <a href="#" class="list-group-item clearfix"> <span class="pull-left thumb-sm avatar m-r"> <img src="assets/images/a7.jpg" alt="John said"> <i class="away b-white bottom"></i> </span> <span class="clear"> <span>Lauren Taylor</span> <small class="text-muted clear text-ellipsis">Nice to talk with you.</small> </span> </a>
                      </ul>
              ...
              <section class="scrollable">
                ...
                <ul class="list-group no-bg no-borders auto">
                  <li class="list-group-item">
                    <div class="media"> <span class="pull-left thumb-sm avatar"> <img src="assets/images/a3.jpg" alt="John said" class="img-circle"> <i class="on b-black bottom"></i> </span>
                  ...
                  <li class="list-group-item">
                    <div class="media"> <span class="pull-left thumb-sm avatar"> <img src="assets/images/a2.jpg" alt="John said"> <i class="on b-black bottom"></i> </span>
                      <div class="media-body">
                  ...
                  <li class="list-group-item">
                    <div class="media"> <span class="pull-left thumb-sm avatar"> <img src="assets/images/a1.jpg" alt="John said"> <i class="busy b-black bottom"></i> </span>
                      <div class="media-body">
                  ...
                  <li class="list-group-item">
                    <div class="media"> <span class="pull-left thumb-sm avatar"> <img src="assets/images/a0.jpg" alt="John said"> <i class="away b-black bottom"></i> </span>
                      <div class="media-body">
...
<script src="<?=config_item('base_url');?>/assets/js/charts/easypiechart/jquery.easy-pie-chart.js"></script>
<script src="<?=config_item('base_url');?>/assets/js/charts/sparkline/jquery.sparkline.min.js"></script>
<script src="<?=config_item('base_url');?>/assets/js/charts/flot/jquery.flot.min.js"></script>
<script src="<?=config_item('base_url');?>/assets/js/charts/flot/jquery.flot.tooltip.min.js"></script>
<script src="<?=config_item('base_url');?>/assets/js/charts/flot/jquery.flot.spline.js"></script>
<script src="<?=config_item('base_url');?>/assets/js/charts/flot/jquery.flot.pie.min.js"></script>
<script src="<?=config_item('base_url');?>/assets/js/charts/flot/jquery.flot.resize.js"></script>
<script src="<?=config_item('base_url');?>/assets/js/charts/flot/jquery.flot.grow.js"></script>
<script src="<?=config_item('base_url');?>/assets/js/charts/flot/demo.js"></script>
<script src="<?=config_item('base_url');?>/assets/js/calendar/bootstrap_calendar.js"></script>
<script src="<?=config_item('base_url');?>/assets/js/calendar/demo.js"></script>
<script src="<?=config_item('base_url');?>/assets/js/sortable/jquery.sortable.js"></script>
